        ...
        return (
            <div className="container mx-auto px-6 py-20 text-center">
                <div className="sage-card p-12 max-w-md mx-auto">
                    ...
                    <h2 className="font-mono text-xl font-bold tracking-wider mb-3 text-[var(--sa-text)]">WALLET REQUIRED</h2>
                    <p className="font-mono text-base text-[var(--sa-text-dim)] tracking-wide mb-6">
                    ...
                    <p className="text-[var(--sa-text-dim)] text-base">
        ...
        return (
            <div className="container mx-auto px-6 py-20 text-center">
                <div className="sage-card p-12 max-w-md mx-auto">
                    ...
                    <h2 className="font-mono text-base font-bold tracking-wider text-[var(--sa-text-dim)]">LOADING PROFILES...</h2>
                </div>
            </div>
        );
    }
        ...
        switch (transferState.step) {
                ...
                return (
                    <>
                        <div className="flex items-center gap-3 mb-6">
                            <span className="font-mono text-sm text-[var(--sa-accent)] font-bold tracking-wider">0001.</span>
                            <h3 className="font-mono text-xl font-bold tracking-wider text-[var(--sa-text)]">TRANSFER AUTHORITY</h3>
                        </div>
                        
                        {/* Step Progress Indicator */}
                        <div className="flex items-center gap-2 mb-6 p-3 bg-[var(--sa-black)] border border-[var(--sa-border)]">
                            <div className="flex items-center gap-2">
                                <div className="w-7 h-7 border-2 border-[var(--sa-accent)] bg-[rgb(var(--sa-accent-rgb-space))]/20 flex items-center justify-center">
                                    <span className="font-mono text-sm text-[var(--sa-accent)] font-bold">1</span>
                                </div>
                                <span className="font-mono text-sm text-[var(--sa-accent)] uppercase tracking-wider">Setup</span>
                            </div>
                            <div className="flex-1 h-[1px] bg-[var(--sa-border)]"></div>
                            <div className="flex items-center gap-2 opacity-40">
                                <div className="w-7 h-7 border border-[var(--sa-border)] flex items-center justify-center">
                                    <span className="font-mono text-sm text-[var(--sa-text-dim)] font-bold">2</span>
                                </div>
                                <span className="font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider">Sign</span>
                            </div>
                            <div className="flex-1 h-[1px] bg-[var(--sa-border)] opacity-40"></div>
                            <div className="flex items-center gap-2 opacity-40">
                                <div className="w-7 h-7 border border-[var(--sa-border)] flex items-center justify-center">
                                    <span className="font-mono text-sm text-[var(--sa-text-dim)] font-bold">3</span>
                                </div>
                                <span className="font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider">Complete</span>
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            <label className="block font-mono text-sm text-emerald-400 uppercase tracking-wider font-bold mb-2 flex items-center gap-2">
            ...
            case 'sign_current':
                return (
                    <>
                        <div className="flex items-center gap-3 mb-6">
                            <span className="font-mono text-sm text-[var(--sa-accent)] font-bold tracking-wider">0002.</span>
                            <h3 className="font-mono text-xl font-bold tracking-wider text-[var(--sa-text)]">SIGN TRANSACTION</h3>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mb-6 p-3 bg-[var(--sa-black)] border border-[var(--sa-border)]">
                            <div className="flex items-center gap-2">
                                <div className="w-6 h-6 border-2 border-amber-500 bg-amber-500/20 flex items-center justify-center">
                                    <span className="font-mono text-sm text-amber-400 font-bold">1</span>
                                </div>
                                <span className="font-mono text-sm text-amber-400 uppercase tracking-wider">Sign Current</span>
                            </div>
                            <div className="flex-1 h-[1px] bg-[var(--sa-border)]"></div>
                            <div className="flex items-center gap-2 opacity-40">
                                ...
                                <span className="font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider">Sign Dest</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <div>
                                <label className="block font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider mb-1 flex items-center gap-2">
                    ...
                    <>
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <span className="font-mono text-sm text-[var(--sa-accent)] font-bold tracking-wider">0003.</span>
                                <h3 className="font-mono text-xl font-bold tracking-wider text-[var(--sa-text)]">CONNECT DESTINATION</h3>
                            </div>
                            {/* Countdown Timer */}
                            {timeRemaining !== null && (
                        ...
                        <div className="flex items-center gap-2 mb-6 p-3 bg-[var(--sa-black)] border border-[var(--sa-border)]">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-mono text-sm text-emerald-400 uppercase tracking-wider">Signed</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-6 h-6 border-2 border-amber-500 bg-amber-500/20 flex items-center justify-center animate-pulse">
                                    <span className="font-mono text-sm text-amber-400 font-bold">2</span>
                                </div>
                                <span className="font-mono text-sm text-amber-400 uppercase tracking-wider">Connect & Sign</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                            <div>
                                ...
                                <div className="sage-input bg-[var(--sa-dark)] border-emerald-500/50 text-emerald-400 text-sm break-all py-2">
                                    {transferState.originalAuthPubkey}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="sage-input bg-[var(--sa-dark)] border-amber-500/50 text-amber-300 text-sm break-all py-2 ring-2 ring-amber-500/30">
                                    {transferState.destinationPubkey}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4 p-3 bg-[var(--sa-dark)] border border-[var(--sa-border)]">
                            <p className="font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider mb-2">Current Connection</p>
                            {isWalletConnected ? (
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                    ...
                                    {isCorrectWallet && (
                                        <span className="ml-2 font-mono text-sm bg-emerald-500/20 text-emerald-400 px-2 py-0.5 border border-emerald-500/30 whitespace-nowrap">
                                            READY
                                        </span>
                                    )}
                                    {isOriginalWallet && (
                                        <span className="ml-2 font-mono text-sm bg-amber-500/20 text-amber-400 px-2 py-0.5 border border-amber-500/30 whitespace-nowrap">
                                            ORIGINAL
                                        </span>
                                    )}
                                </div>
                            ) : (
                                <p className="font-mono text-sm text-[var(--sa-text-dim)]">No wallet connected</p>
                            )}
                        </div>
            ...
            case 'sign_destination':
                return (
                    <>
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                <span className="font-mono text-sm text-emerald-400 font-bold tracking-wider">FINAL</span>
                                <h3 className="font-mono text-xl font-bold tracking-wider text-[var(--sa-text)]">COMPLETE TRANSFER</h3>
                            </div>
                            {/* Countdown Timer */}
                            {timeRemaining !== null && (
                                <div className={`flex items-center gap-2 px-3 py-1.5 border ${
                        ...
                        <div className="flex items-center gap-2 mb-6 p-3 bg-[var(--sa-black)] border border-emerald-500/30">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-mono text-sm text-emerald-400 uppercase tracking-wider">Connected</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <div>
                                ...
                                <div className="sage-input bg-[var(--sa-dark)] border-emerald-500/50 text-emerald-400 text-sm break-all py-2 ring-2 ring-emerald-500/30">
                                    {transferState.destinationPubkey}
                                </div>
                            </div>
                        </div>
                ...
                return (
                    <>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="font-mono text-xl font-bold tracking-wider text-emerald-400">TRANSFER COMPLETE</h3>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                            <div>
                                <label className="block font-mono text-sm text-red-400/70 uppercase tracking-wider mb-1 flex items-center gap-2">
                                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                                    REMOVED — Previous Auth Key
                                </label>
                                <div className="sage-input bg-[var(--sa-dark)] border-red-500/20 text-red-400/50 text-sm break-all py-2 line-through">
                                    {transferState.originalAuthPubkey}
                                </div>
                            </div>
                            <div className="flex justify-center py-1">
                ...
                return (
                    <>
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="font-mono text-xl font-bold tracking-wider text-red-400">TRANSACTION EXPIRED</h3>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mb-6 p-3 bg-[var(--sa-black)] border border-red-500/30">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-mono text-sm text-red-400 uppercase tracking-wider">Expired</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 mb-6">
                            <div>
                                <label className="block font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider mb-1">From (Current Auth)</label>
                                <div className="sage-input bg-[var(--sa-dark)] text-[var(--sa-text-dim)] text-sm break-all py-2 opacity-60">
                                    {transferState.originalAuthPubkey}
                                </div>
                            </div>
                            <div>
                                <label className="block font-mono text-sm text-[var(--sa-text-dim)] uppercase tracking-wider mb-1">To (Destination)</label>
                                <div className="sage-input bg-[var(--sa-dark)] text-[var(--sa-text-dim)] text-sm break-all py-2 opacity-60">
                                    {transferState.destinationPubkey}
                                </div>
                            </div>
        ...
        <div className="container mx-auto px-6">
                ...
                <div className="sage-card p-4 mb-4">
                    ...
                    {debugInfo && (
                        <div className="mt-2 bg-[var(--sa-black)] border border-[var(--sa-border)] px-3 py-2">
                            <p className="font-mono text-sm text-[var(--sa-text-dim)]">{debugInfo}</p>
                        </div>
                    )}
                </div>
            )}
            ...
            {!isTransferInProgress && profiles.length === 0 ? (
                <div className="sage-card p-8 text-center">
                        <p className="font-mono text-base text-[var(--sa-text-dim)] tracking-wide">No profiles found for this wallet.</p>
                </div>
            ) : !isTransferInProgress && (
                        ...
                        <div key={profile.key.toBase58()} className="sage-card overflow-hidden animate-fade-in-up" style={{ animationDelay: `${profileIndex * 0.1}s` }}>
                            ...
                            <div className="bg-[var(--sa-black)] border-b border-[var(--sa-border)] px-4 py-2.5 flex items-center justify-between">
                                <div className="flex items-center gap-4 flex-wrap">
                                    <div className="flex items-center gap-2">
                                        <span className="font-mono text-sm text-[var(--sa-accent)] font-bold tracking-wider">
                                            {String(profileIndex + 1).padStart(4, '0')}.
                                        </span>
                                        <span className="font-mono text-sm font-bold tracking-wider text-[var(--sa-text)]">PROFILE</span>
                                    </div>
                                    ...
                                    <span className="font-mono text-sm text-cyan-400 break-all hidden lg:block font-semibold tracking-wide">{profile.key.toBase58()}</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="hidden md:flex items-center gap-4 text-[var(--sa-text-dim)]">
                                        <span className="font-mono text-sm">Created: <span className="text-[var(--sa-text)]">{new Date(profile.data.createdAt.toNumber() * 1000).toLocaleDateString()}</span></span>
                                        <span className="font-mono text-sm">Threshold: <span className="text-[var(--sa-text)]">{profile.data.keyThreshold}</span></span>
                                    </div>
                            ...
                            <div className="lg:hidden px-4 py-2 bg-[var(--sa-dark)] border-b border-[var(--sa-border)]">
                                <span className="font-mono text-sm text-cyan-400 break-all font-semibold tracking-wide">{profile.key.toBase58()}</span>
                            </div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    <thead className="bg-[var(--sa-dark)]">
                                        <tr>
                                            <th className="px-4 py-2 font-mono text-sm uppercase tracking-wider text-[var(--sa-text-dim)] font-bold">Key</th>
                                            <th className="px-3 py-2 font-mono text-sm uppercase tracking-wider text-[var(--sa-text-dim)] font-bold">Permissions</th>
                                            <th className="px-3 py-2 font-mono text-sm uppercase tracking-wider text-[var(--sa-text-dim)] font-bold">Expiry</th>
                                            <th className="px-3 py-2 font-mono text-sm uppercase tracking-wider text-[var(--sa-text-dim)] font-bold text-right">Actions</th>
                                        </tr>
                                    </thead>
                                        ...
                                        {profile.profileKeys.map((pk, idx) => {
                                            ...
                                            return (
                                                <tr key={`${profile.key.toBase58()}-${idx}`} className="hover:bg-[rgb(var(--sa-accent-rgb-space))]/5 transition-colors">
                                                    <td className="px-4 py-3 font-mono text-sm text-[var(--sa-text)]">
                                                        <div className="flex items-center gap-2">
                                                            <span 
                                                            ...
                                                            {isMe && (
                                                                <span className="font-mono text-sm bg-emerald-500/20 text-emerald-400 px-2 py-1 border border-emerald-500/30 whitespace-nowrap">
                                                                    YOU
                                                                </span>
                                                            )}
                                                        </div>
                                                    ...
                                                    <td className="px-3 py-3">
                                                        <div className="flex flex-wrap gap-1">
                                                            {isAuth && (
                                                                <span className="font-mono text-sm bg-red-500/20 text-red-400 px-2 py-1 border border-red-500/30">AUTH</span>
                                                                )}
                                                                {perms.addKeys && (
                                                                    <span className="font-mono text-sm bg-blue-500/20 text-blue-400 px-2 py-1 border border-blue-500/30">ADD</span>
                                                                )}
                                                                {perms.removeKeys && (
                                                                    <span className="font-mono text-sm bg-amber-500/20 text-amber-400 px-2 py-1 border border-amber-500/30">RM</span>
                                                                )}
                                                            </div>
                                                        </td>
                                                        <td className="px-3 py-2 font-mono text-sm text-[var(--sa-text-dim)]">
                                                        ...
                                                        <td className="px-3 py-2 text-right">
                                                            {isAuth && isMe ? (
                                                                <button 
                                                                    ...
                                                                    className="font-mono text-sm text-[var(--sa-accent)] hover:text-[var(--sa-accent-hover)] uppercase font-bold tracking-wider disabled:opacity-50 transition-colors"
                                                                    disabled={processing}
                                                                >
                                                                    TRANSFER
                                                                </button>
                                                                ...
                                                                !isAuth && (
                                                                    <button 
                                                                        ...
                                                                        className="font-mono text-sm text-red-400 hover:text-red-300 uppercase font-bold tracking-wider disabled:opacity-50 transition-colors"
                                                                        disabled={processing}
                                                                    >
                                                                        DELETE
                                                                    </button>
